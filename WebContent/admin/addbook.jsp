...
<body>
	...
	<div id="rightSide">
		...
		<div class="line"></div>
		<div class="wrapper">
			<form action="book/addBook.action" name="myform" method="post" onsubmit="return check()" class="form">
				<div class="widget" style="width: 80%">
					...
					<div class="formRow">
						<label>图书名称</label>
						<div class="formRight">
							<input type="text" name="bookname" class="mws-textinput" id="bookname" placeholder="请输入图书名称" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">

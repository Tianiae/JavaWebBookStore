			...
			<form action="cate/updateCate.action" name="myform" method="post" onsubmit="return check()" class="form">
				<div class="widget" style="width: 40%">
					...
					<div class="formRow">
						<label>类型名称</label>
						<div class="formRight">
							<input type="text" name="catename" class="mws-textinput" id="catename" value="${cate.catename}" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
						<label>备注</label>
						<div class="formRight">
							<input type="text" name="memo" class="mws-textinput" id="memo" value="${cate.memo}" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formSubmit">
						<input type="hidden" name="cateid" id="cateid" value="${cate.cateid}" /><input type="hidden" name="addtime"
							id="addtime" value="${cate.addtime}" /> <input type="submit" id="sub" value="确认提交" class="redB">

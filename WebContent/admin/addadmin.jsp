			...
			<form action="admin/addAdmin.action" name="myform" method="post" onsubmit="return check()" class="form">
				<div class="widget" style="width: 40%">
					...
					<div class="formRow">
						<label>用户名</label>
						<div class="formRight">
							<input type="text" name="username" class="mws-textinput" id="username" placeholder="请输入用户名" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
					...
					<div class="formRow">
						<label>姓名</label>
						<div class="formRight">
							<input type="text" name="realname" class="mws-textinput" id="realname" placeholder="请输入姓名" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
						<label>联系方式</label>
						<div class="formRight">
							<input type="text" name="contact" class="mws-textinput" id="contact" placeholder="请输入联系方式" />
						</div>
						<div class="clear"></div>
					</div>

...
<div class="ng-header">
	<div class="ng-header-con block">
		<div class="ng-header-box">
			<a href="index.jsp" class="logo" style="width:250px;"> 
			<img src="themes/xecmoban_haier2015/images/zj.png" style="height:100%;vertical-align:middle;" />
			<span style="    font-size: 24px;
    font-weight: bold;
    margin-left: 20px;
    letter-spacing: 3px;">网上书城</span>
			</a>
			<div class="ng-search">
				<div class="g-search">
	...
	<div class="block">
		<div class="ng-nav-index">
			<ul class="ng-nav">
				...
				<li><a href="index/recommend.action" class="cur">推荐图书</a></li>
				<li><a href="index/all.action" class="cur">全部图书</a></li>
			</ul>
		</div>
	</div>
</div>

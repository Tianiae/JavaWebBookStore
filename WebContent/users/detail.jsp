	...
	<div class="block clearfix">
		...
		<div class="AreaR">
			...
			<div id="goodsInfo" class="clearfix">
				<div class="imgInfo">
					<img src="${goods.image}" alt="${goods.bookname }" width="360px;" height="360px" />
					<div class="blank5"></div>
					<div class="blank"></div>
				</div>
				<div class="textInfo">
					<form action="index/addcart.action" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
						<h1 class="clearfix">${goods.bookname }</h1>
						<ul class="ul2 clearfix">
							...
							<li class="clearfix" style="width: 100%">
								<dd>
									<strong>图书类型：</strong><a href="index/cate.action?id=${goods.cateid }">${goods.catename }</a>
								</dd>
							</li>
							...
							<li class="clearfix">
								<dd>
									<strong>购买数量：</strong> <input name="num" type="text" id="number" value="1" size="4"
										style="border: 1px solid #ccc;" /> <input type="hidden" name="goodsid" value="${goods.bookid }" /> <input
									...
									<table width="710" border="0" cellspacing="5" cellpadding="0">
										...
										<tr>
											...
											<td><textarea name="contents" class="inputBorder" style="height: 50px; width: 620px;"></textarea> <input
												type="hidden" name="goodsid" value="${goods.bookid }" /></td>
										</tr>
										<tr>

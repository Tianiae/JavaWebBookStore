					...
					<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
						...
						<c:forEach items="${detailsList}" var="orders">
							<tr>
								...
								<td align="center" bgcolor="#ffffff">${orders.bookname}</td>
								<td align="center" bgcolor="#ffffff">${orders.price}</td>
								<td align="center" bgcolor="#ffffff">${orders.num}</td>
								<td align="center" bgcolor="#ffffff">${orders.receivername}</td>
								<td align="center" bgcolor="#ffffff">${orders.receiverphone}</td>
